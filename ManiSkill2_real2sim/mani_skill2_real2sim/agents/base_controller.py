...
class BaseController:
    ...
    def __init__(
        ...
        if sim_freq is None:  # infer from scene
            # TODO: update sapien interface to avoid this workaround
        ...
        # NOTE: It is intended not to be a required field in config.
...
class ControllerConfig:
    ...
    # NOTE: It is a class variable in this base class,
