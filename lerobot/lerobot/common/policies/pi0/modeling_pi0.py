...
class PI0Policy(PreTrainedPolicy):
    ...
    def select_action(
        ...
        actions, vlm_logits, logits_tuple = self.model.sample_actions(
        ...
        return actions, vlm_logits, logits_tuple
...
class PI0FlowMatching(nn.Module):
    ...
    def sample_actions(
    ...
    ) -> Tuple[Union[Tensor, Any], Any, Union[Tuple, Any]]:
        ...
        _, vlm_logits, expert_logits, past_key_values = self.paligemma_with_expert.forward(
        ...
        while time >= -dt / 2:
            ...
            expert_logits_tuple = expert_logits_tuple + (logits, )
            # Euler step
            x_t += dt * v_t
            time += dt
        return x_t, vlm_logits, expert_logits_tuple
    ...
    def denoise_step(
        ...
        outputs_embeds, vlm_logits, expert_logits, _ = self.paligemma_with_expert.forward(
