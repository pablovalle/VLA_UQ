...
class PrismaticForConditionalGeneration(PrismaticPreTrainedModel):
    ...
    def forward(
        ...
        # print('logits: ', language_model_output.logits)
...
class OpenVLAForActionPrediction(PrismaticForConditionalGeneration):
    ...
    def predict_action(
        ...
        import inspect
        import os
        # print('path: ', inspect.getfile(self.generate))
        # print(inspect.getsourcelines(self.generate))
        # Run VLA inference
        generated_ids, scores = self.generate(input_ids, max_new_tokens=self.get_action_dim(unnorm_key), **kwargs)
